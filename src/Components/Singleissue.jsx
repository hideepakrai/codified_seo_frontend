...
export default function IssueDetails() {
  ...
  // const [inlinkid, setInlinkid] = useState(rid);
            ...
            <div className="space-y-3">
              {inlinks.map((inlink, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="p-3 flex items-center justify-between rounded-xl bg-blue-900/20 border border-blue-600/30 shadow-sm"
                  >
                    <div>
                    ...
                    <Link
                      ...
                      className="flex items-center justify-center rounded-full bg-white text-black hover:bg-black hover:text-white w-10 h-10 transition-all duration-300 cursor-pointer"
                    >
