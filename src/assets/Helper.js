...
export const issueKeys = {
  ...
  ERROR_SLOW_TTFB: "ERROR_SLOW_TTFB",
  ERROR_NOT_VALID_HEADINGS: "ERROR_NOT_VALID_HEADINGS",
  ERROR_LONG_DESCRIPTION: "ERROR_LONG_DESCRIPTION",
  ERROR_LONG_TITLE: "ERROR_LONG_TITLE",
  NON_CANONICAL_IN_SITEMAP: "NON_CANONICAL_IN_SITEMAP",
  ERROR_IMAGES_NO_ALT: "ERROR_IMAGES_NO_ALT",
  ERROR_SHORT_DESCRIPTION: "ERROR_SHORT_DESCRIPTION",
  ERROR_LONG_ALT_TEXT: "ERROR_LONG_ALT_TEXT",
  ERROR_MULTIPLE_SLASHES: "ERROR_MULTIPLE_SLASHES",
  ERROR_UNDERSCORE_URL: "ERROR_UNDERSCORE_URL",
  ERROR_TOO_MANY_LINKS: "ERROR_TOO_MANY_LINKS",
  ERROR_IMG_SIZE_ATTR: "ERROR_IMG_SIZE_ATTR",
  ERROR_EXTERNAL_WITHOUT_NOFOLLOW: "ERROR_EXTERNAL_WITHOUT_NOFOLLOW",
  ERROR_MISSING_CSP: "ERROR_MISSING_CSP",
  ERROR_CONTENT_TYPE_OPTIONS: "ERROR_CONTENT_TYPE_OPTIONS",
  ERROR_EXTERNAL_LINK_REDIRECT: "ERROR_EXTERNAL_LINK_REDIRECT",
  ERROR_EXTERNAL_LINK_BROKEN: "ERROR_EXTERNAL_LINK_BROKEN",
  ERROR_DUPLICATED_ID: "ERROR_DUPLICATED_ID",
  ERROR_LARGE_IMAGE: "ERROR_LARGE_IMAGE",
  ERROR_PAGE_DEPTH: "ERROR_PAGE_DEPTH",
  ERROR_MISSING_HSTS: "ERROR_MISSING_HSTS",
  ERROR_DOM_SIZE: "ERROR_DOM_SIZE",
  ERROR_ORPHAN: "ERROR_ORPHAN",
  ERROR_INCORRECT_MEDIA_TYPE: "ERROR_INCORRECT_MEDIA_TYPE",

  BLOCKED_IN_SITEMAP: "BLOCKED_IN_SITEMAP",
  DEAD_END: "DEAD_END",
  ERROR_30x: "ERROR_30x",
  ERROR_40x: "ERROR_40x",
  ERROR_50x: "ERROR_50x",
  ERROR_BLOCKED: "ERROR_BLOCKED",
  ERROR_CANONICAL_ERROR: "ERROR_CANONICAL_ERROR",
  ERROR_CANONICAL_MISMATCH: "ERROR_CANONICAL_MISMATCH",
  ERROR_CANONICAL_REDIRECT: "ERROR_CANONICAL_REDIRECT",
  ERROR_CANONICALIZED_NON_CANONICAL: "ERROR_CANONICALIZED_NON_CANONICAL",
  ERROR_CANONICALIZED_NON_INDEXABLE: "ERROR_CANONICALIZED_NON_INDEXABLE",
  ERROR_DUPLICATED_CONTENT: "ERROR_DUPLICATED_CONTENT",
  ERROR_DUPLICATED_DESCRIPTION: "ERROR_DUPLICATED_DESCRIPTION",
  ERROR_DUPLICATED_TITLE: "ERROR_DUPLICATED_TITLE",
  ERROR_EMPTY_DESCRIPTION: "ERROR_EMPTY_DESCRIPTION",
  ERROR_EMPTY_TITLE: "ERROR_EMPTY_TITLE",
  ERROR_HREFLANG_ERROR: "ERROR_HREFLANG_ERROR",
  ERROR_HREFLANG_MISMATCHING_LANG: "ERROR_HREFLANG_MISMATCHING_LANG",
  ERROR_HREFLANG_NO_INDEXABLE: "ERROR_HREFLANG_NO_INDEXABLE",
  ERROR_HREFLANG_REDIRECT: "ERROR_HREFLANG_REDIRECT",
  ERROR_HREFLANG_RELATIVE_URL: "ERROR_HREFLANG_RELATIVE_URL",
  ERROR_HREFLANG_RETURN: "ERROR_HREFLANG_RETURN",
  ERROR_HREFLANG_SELF_REFERENCE: "ERROR_HREFLANG_SELF_REFERENCE",
  ERROR_HREFLANG_TO_NON_CANONICAL: "ERROR_HREFLANG_TO_NON_CANONICAL",
  ERROR_HREFLANG_XDEFAULT: "ERROR_HREFLANG_XDEFAULT",
  ERROR_HTTP_FORM: "ERROR_HTTP_FORM",
  ERROR_HTTP_LINKS: "ERROR_HTTP_LINKS",
  ERROR_INSECURE_FORM: "ERROR_INSECURE_FORM",
  ERROR_INTERNAL_NOFOLLOW: "ERROR_INTERNAL_NOFOLLOW",
  ERROR_LITTLE_CONTENT: "ERROR_LITTLE_CONTENT",
  ERROR_LOCALHOST_LINKS: "ERROR_LOCALHOST_LINKS",
  ERROR_METAS_IN_BODY: "ERROR_METAS_IN_BODY",
  ERROR_MISSING_VIEWPORT: "ERROR_MISSING_VIEWPORT",
  ERROR_MULTIPLE_CANONICAL_TAGS: "ERROR_MULTIPLE_CANONICAL_TAGS",
  ERROR_MULTIPLE_DESCRIPTIONS: "ERROR_MULTIPLE_DESCRIPTIONS",
  ERROR_MULTIPLE_LANG_REFERENCE: "ERROR_MULTIPLE_LANG_REFERENCE",
  ERROR_MULTIPLE_TITLES: "ERROR_MULTIPLE_TITLES",
  ERROR_NO_H1: "ERROR_NO_H1",
  ERROR_NO_INDEXABLE: "ERROR_NO_INDEXABLE",
  ERROR_NO_LANG: "ERROR_NO_LANG",
  ERROR_NOFOLLOW_INDEXABLE: "ERROR_NOFOLLOW_INDEXABLE",
  ERROR_NOIMAGEINDEX: "ERROR_NOIMAGEINDEX",
  ERROR_NOSNIPPET: "ERROR_NOSNIPPET",
  ERROR_PAGINATION_LINKS: "ERROR_PAGINATION_LINKS",
  ERROR_PICTURE_MISSONG_IMG: "ERROR_PICTURE_MISSONG_IMG",
  ERROR_REDIRECT_CHAIN: "ERROR_REDIRECT_CHAIN",
  ERROR_REDIRECT_LOOP: "ERROR_REDIRECT_LOOP",
  ERROR_RELATIVE_CANONICAL_URL: "ERROR_RELATIVE_CANONICAL_URL",
  ERROR_SHORT_TITLE: "ERROR_SHORT_TITLE",
  ERROR_SPACE_URL: "ERROR_SPACE_URL",
  HTTP_SCHEME: "HTTP_SCHEME",
  INCOMING_FOLLOW_NOFOLLOW: "INCOMING_FOLLOW_NOFOLLOW",
  INVALID_LANG: "INVALID_LANG",
  NO_INDEX_IN_SITEMAP: "NO_INDEX_IN_SITEMAP",
};
